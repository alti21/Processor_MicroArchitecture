...
HD_PWD='C:/Users/Alti/multiplier/multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_for_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_for_multiplier.tcl
