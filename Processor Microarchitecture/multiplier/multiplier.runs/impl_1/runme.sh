...
HD_PWD='C:/Users/Alti/multiplier/multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_for_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_for_multiplier.tcl -notrace
